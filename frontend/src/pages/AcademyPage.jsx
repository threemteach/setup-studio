...
const defaultFaqs = [
  {
    qEn: "Do I need previous video production experience?",
    qAr: "هل أحتاج إلى خبرة سابقة في إنتاج الفيديو؟",
    aEn: "No. The Video Content Foundation Course is designed for beginners and anyone who wants to build a stronger practical foundation.",
    aAr: "لا. دورة أساسيات إنتاج المحتوى المرئي مصممة للمبتدئين وأي شخص يرغب في بناء أساس عملي أقوى.",
  },
  {
    qEn: "Do I need to have my own camera?",
    qAr: "هل أحتاج إلى امتلاك كاميرا خاصة بي؟",
    aEn: "Having a camera is helpful, but the course is also suitable for those who want to understand video production basics before investing in equipment.",
    aAr: "امتلاك كاميرا مفيد، لكن الدورة مناسبة أيضاً لمن يريدون فهم أساسيات إنتاج الفيديو قبل الاستثمار في المعدات.",
  },
  {
    qEn: "Is the course practical or theoretical?",
    qAr: "هل الدورة عملية أم نظرية؟",
    aEn: "The course is practical — with explanation, demonstration, and hands-on application inside Setup Studio using real equipment and scenarios.",
    aAr: "الدورة عملية — مع الشرح والعرض والتطبيق العملي داخل سيت أب ستوديو باستخدام معدات وسيناريوهات حقيقية.",
  },
  {
    qEn: "What makes Setup Academy different?",
    qAr: "ما الذي يميز أكاديمية سيت أب؟",
    aEn: "Setup Academy is built inside a real production studio. You learn by doing — using professional equipment, real sets, and actual production workflows.",
    aAr: "أكاديمية سيت أب مبنية داخل استوديو إنتاج حقيقي. تتعلم بالممارسة — باستخدام معدات احترافية ومجموعات تصوير حقيقية وسير عمل إنتاجي فعلي.",
  },
]
        ...
        <div className="max-w-[1280px] mx-auto px-[clamp(1rem,4vw,3rem)]">
          <div className="flex flex-col items-center text-center mb-[clamp(2rem,4vw,4rem)]">
            ...
            <div className="flex items-center justify-center w-full mb-3">
              ...
              <h2 className="text-navy font-bold text-[clamp(1.5rem,4vw,2.5rem)] leading-tight mx-[clamp(0.75rem,2vw,1.5rem)] whitespace-nowrap">
            ...
            <p className="text-navy/60 text-[clamp(0.9rem,1.3vw,1rem)] max-w-[600px] mx-auto leading-relaxed">
          ...
          <div className={`grid grid-cols-1 lg:grid-cols-2 gap-[clamp(2rem,4vw,4rem)] items-center ${lang === 'ar' ? '[&>*:first-child]:lg:order-2 [&>*:last-child]:lg:order-1' : ''}`}>
            ...
            <Reveal delay={0.15}>
              <p className={`text-navy/60 text-[clamp(0.9rem,1.3vw,1rem)] leading-relaxed mb-6 ${lang === 'ar' ? 'text-right' : ''}`}>
              ...
              <ul className="space-y-3 m-0 p-0 list-none">
                {differences.map((item, i) => (
                  <li key={i} className="flex items-start gap-3 text-navy/70 text-[clamp(0.85rem,1.2vw,0.95rem)]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-[clamp(0.75rem,1.5vw,1.25rem)]">
            {audiences.map((item, i) => (
              <Reveal key={i} delay={i * 0.05}>
                <div className="group p-[clamp(1.25rem,2vw,1.75rem)] rounded-2xl border border-border bg-white hover:shadow-[0_8px_32px_rgba(48,93,116,0.1)] hover:border-navy/20 transition-all duration-300 h-full hover:-translate-y-0.5">
                  <span className="w-[clamp(2rem,2.5vw,2.5rem)] h-[clamp(2rem,2.5vw,2.5rem)] rounded-full bg-navy text-white text-[clamp(0.8rem,1vw,1rem)] font-bold flex items-center justify-center mb-3">
                    {i + 1}
                  </span>
        ...
        <div className="max-w-[1280px] mx-auto px-[clamp(1rem,4vw,3rem)] relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-[clamp(1.5rem,3vw,2.5rem)]">
            ...
            <Reveal className="h-full">
              <a
                href="/#"
                className="group block h-full flex flex-col no-underline rounded-[clamp(1.5rem,3vw,3rem)] border border-border bg-white overflow-hidden hover:shadow-[0_12px_48px_rgba(48,93,116,0.16)] hover:border-navy/20 transition-all duration-500 hover:-translate-y-1 cursor-pointer"
              ...
              >
                ...
                <div className="p-[clamp(1.25rem,2.5vw,2rem)] flex flex-col gap-4">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-navy font-bold text-[clamp(1.2rem,2.5vw,1.5rem)] m-0">
                      {cms("first_course_heading") || t("Video Content Foundation Course", "دورة أساسيات إنتاج المحتوى المرئي", lang)}
                    </h3>
                  </div>
                  <p className={`text-navy/60 text-[clamp(0.85rem,1.2vw,0.95rem)] leading-relaxed m-0 ${lang === 'ar' ? 'text-right' : ''}`}>
                    {cms("first_course_desc") || t("Learn professional video production through hands-on practice inside Setup Studio with real lighting, audio, and shooting setups.", "تعلم إنتاج الفيديو الاحترافي من خلال التطبيق العملي داخل سيت أب ستوديو بإضاءة حقيقية وصوت وإعدادات تصوير احترافية.", lang)}
                  </p>
                  {/* Focus items */}
                  <div className="bg-[#f8f9fb] rounded-xl p-[clamp(1rem,1.5vw,1.25rem)]">
                    <h4 className="text-navy font-semibold text-[clamp(0.85rem,1.2vw,0.95rem)] mb-2.5 flex items-center gap-2">
                      <i className="fa-solid fa-list-check text-red text-[0.75rem]" />
                      {t("Course Focus", "محاور الدورة", lang)}
                    </h4>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-1.5">
                      {focusItems.map((item, i) => (
                        <span key={i} className="text-navy/60 text-[clamp(0.75rem,1vw,0.85rem)] flex items-center gap-2">
                  ...
                  <div className="flex items-center justify-between pt-2 border-t border-border/50">
                    <span className="text-muted text-[0.75rem] flex items-center gap-1.5">
                      <i className="fa-regular fa-clock text-navy/40" />
                      {t("Limited spots available", "أماكن محدودة متاحة", lang)}
                    </span>
                    <a
                      href={`https://wa.me/201012846764?text=${encodeURIComponent("Hi setupstudio! I want to join the Setup Academy waiting list.")}`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-navy font-semibold text-[0.85rem] hover:text-red transition-colors duration-200 flex items-center gap-2 no-underline"
                    >
            ...
            <Reveal delay={0.15} className="h-full">
              <div className="rounded-[clamp(1.5rem,3vw,3rem)] border border-border bg-white overflow-hidden h-full flex flex-col">
                <div className="relative">
                  <img
                ...
                <div className="p-[clamp(1.25rem,2.5vw,2rem)] flex flex-col gap-4">
                  <div>
                    ...
                    <h3 className="text-navy font-bold text-[clamp(1.35rem,2.8vw,1.65rem)] m-0 leading-tight">
                  ...
                  <div className="flex items-center gap-3 p-3 rounded-xl bg-[#f8f9fb] border border-dashed border-navy/10">
                    ...
                    <p className={`text-navy/45 text-[clamp(0.7rem,0.9vw,0.8rem)] m-0 leading-relaxed ${lang === 'ar' ? 'text-right' : ''}`}>
                      {cms("instructor_info") || t("Full instructor details — including background, experience, and teaching approach — will be announced before the course launch.", "سيتم الإعلان عن تفاصيل المدرب — بما في ذلك الخلفية والخبرة وطريقة التدريس — قبل إطلاق الدورة.", lang)}
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className="w-full bg-white py-[clamp(2rem,5vw,5rem)] overflow-hidden">
        <div className="max-w-[1280px] mx-auto px-[clamp(1rem,4vw,3rem)]">
          ...
          <div className={`grid grid-cols-1 lg:grid-cols-2 gap-[clamp(2rem,4vw,4rem)] items-center ${lang === 'ar' ? '[&>*:first-child]:lg:order-2 [&>*:last-child]:lg:order-1' : ''}`}>
            ...
            <Reveal delay={0.15}>
              <p className={`text-navy/60 text-[clamp(0.9rem,1.3vw,1rem)] leading-relaxed mb-5 ${lang === 'ar' ? 'text-right' : ''}`}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {(cmsData?.production_stages || [
                  ...
                  <div key={i} className="flex items-start gap-3 p-4 rounded-xl border border-border bg-white hover:shadow-[0_4px_16px_rgba(48,93,116,0.06)] transition-all duration-200">
                    <div className="w-9 h-9 rounded-lg bg-navy/10 flex items-center justify-center shrink-0">
                      <i className={`${item.icon} text-navy text-[0.9rem]`} />
                    </div>
                    <div>
                      <h4 className="text-navy font-semibold text-[0.85rem] m-0">{t(item.titleEn, item.titleAr, lang)}</h4>
                      <p className="text-navy/50 text-[0.75rem] leading-relaxed m-0 mt-0.5">{t(item.descEn, item.descAr, lang)}</p>
                    </div>
                  </div>
                ))}
              </div>
          ...
          <div className={`grid grid-cols-1 lg:grid-cols-2 gap-[clamp(2rem,4vw,4rem)] items-center ${lang === 'ar' ? '[&>*:first-child]:lg:order-2 [&>*:last-child]:lg:order-1' : ''}`}>
            ...
            <Reveal delay={0.15}>
              ...
              <p className={`text-white/60 text-[clamp(0.9rem,1.3vw,1rem)] leading-relaxed ${lang === 'ar' ? 'text-right' : ''}`}>
                {cms("beyond_body") || t("Setup Academy is about helping learners take their first serious steps into the creative field. Outstanding students stay connected with Setup Studio through workshops, advanced courses, internships, and creative collaborations — building a community of future professionals.", "أكاديمية سيت أب تدور حول مساعدة المتعلمين على اتخاذ خطواتهم الجادة الأولى في المجال الإبداعي. الطلاب المتميزون يبقون على اتصال مع سيت أب ستوديو من خلال ورش العمل والدورات المتقدمة والتدريب الداخلي والتعاون الإبداعي — بناء مجتمع من المحترفين المستقبليين.", lang)}
              </p>
            </Reveal>
          </div>
        </div>
        ...
        <div className="max-w-[1280px] mx-auto px-[clamp(1rem,4vw,3rem)]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-[clamp(0.75rem,1.5vw,1.25rem)]">
            {upcomingCourses.map((course, i) => (
              <Reveal key={i} delay={i * 0.05}>
                <div className="group p-[clamp(1.25rem,2vw,1.5rem)] rounded-2xl border border-border bg-white hover:shadow-[0_8px_32px_rgba(48,93,116,0.1)] hover:border-navy/20 transition-all duration-300 h-full hover:-translate-y-0.5">
                  <div className="w-10 h-10 rounded-full bg-navy/10 flex items-center justify-center mb-3 group-hover:bg-navy transition-colors duration-300">
                    <i className={`${course.icon} text-navy text-[1rem] group-hover:text-white transition-colors duration-300`} />
                  </div>
                    <h3 className="text-navy font-bold text-[clamp(0.85rem,1.2vw,1rem)] m-0 mb-1.5">
                      {t(course.titleEn, course.titleAr, lang)}
                    </h3>
                    <p className={`text-navy/50 text-[clamp(0.75rem,1vw,0.85rem)] leading-relaxed m-0 ${lang === 'ar' ? 'text-right' : ''}`}>
              ...
              <Reveal key={i} delay={i * 0.04}>
                <div
                  className={`rounded-2xl border cursor-pointer transition-all duration-300 ${
                    openFaq === i
                      ? "border-navy bg-white shadow-[0_4px_20px_rgba(48,93,116,0.08)]"
                      : "border-border bg-white hover:border-navy/20 hover:shadow-sm"
                  }`}
                  onClick={() => setOpenFaq(openFaq === i ? null : i)}
                >
                  <div className="flex items-center justify-between px-[clamp(1rem,2vw,1.5rem)] py-[clamp(0.85rem,1.5vw,1.15rem)]">
                    <h3 className="text-navy font-semibold text-[clamp(0.85rem,1.2vw,0.95rem)] m-0 ltr:pr-4 rtl:pl-4 leading-snug">
                      {t(faq.qEn, faq.qAr, lang)}
                    </h3>
                    <span className={`shrink-0 w-7 h-7 rounded-full bg-navy/5 flex items-center justify-center text-navy/50 text-sm transition-all duration-300 ${openFaq === i ? "rotate-45 bg-red/10 text-red" : ""}`}>
                  ...
                  >
                    <p className="text-navy/60 text-[clamp(0.8rem,1.1vw,0.9rem)] leading-relaxed m-0 px-[clamp(1rem,2vw,1.5rem)] pb-[clamp(0.85rem,1.5vw,1.15rem)]">
              ...
              <div className="relative z-10 w-full flex flex-col md:flex-row items-center justify-between gap-[clamp(1.25rem,3vw,2.5rem)] px-[clamp(1.5rem,4vw,3.5rem)] py-[clamp(1.5rem,3vw,2.5rem)]">
                <div className={`text-center ${lang === 'ar' ? 'md:text-right' : 'md:text-left'}`}>
                  <div className="flex items-center justify-center w-full mb-2">
                    ...
                    <h2 className="text-white font-bold text-[clamp(1.3rem,3vw,2.2rem)] mx-[clamp(0.75rem,2vw,1.5rem)] whitespace-nowrap leading-tight">
                      {cms("cta_title") || (<> {t("Start Your", "ابدأ", lang)} <span className="text-[#11AFFF]">{t("Creative Journey", "رحلتك الإبداعية", lang)}</span> </>)}
                    </h2>
                    <div className="flex items-center min-w-0 shrink">
                      <span className="block w-[clamp(1.5rem,8vw,10rem)] h-[2px] bg-red" />
                      <svg className="w-[clamp(0.4rem,0.9vw,0.8rem)] h-[clamp(0.4rem,0.9vw,0.8rem)] text-red shrink-0" viewBox="0 0 13 13" fill="currentColor">
                  ...
                  <p className={`text-white/50 text-[clamp(0.8rem,1.3vw,1rem)] mt-2 m-0 max-w-[36rem] leading-relaxed ${lang === 'ar' ? 'text-right' : ''}`}>
                    {cms("cta_body") || t("Join our first Video Content Foundation Course and take your first step into professional video production.", "انضم إلى دورتنا الأولى لأساسيات إنتاج المحتوى المرئي واتخذ خطوتك الأولى في إنتاج الفيديو الاحترافي.", lang)}
                  </p>
                </div>
                <a
                  href={`https://wa.me/201012846764?text=${encodeURIComponent("Hi setupstudio! I want to join the Setup Academy waiting list.")}`}
