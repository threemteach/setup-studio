        ...
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 mb-8">
            {stats.map((s) => (
              <div
                key={s.label}
                className="group relative bg-white rounded-2xl border border-border/80 p-5.5 hover:shadow-xl hover:shadow-navy/[0.04] hover:-translate-y-1 transition-all duration-300 overflow-hidden"
              >
                ...
                <p className="text-muted text-xs font-semibold uppercase tracking-wider m-0 mb-1">{s.label}</p>
                <p className="text-navy font-bold text-2.5xl m-0 tracking-tight leading-none">{s.value}</p>
              </div>
            ))}
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6.5 mb-8">
            ...
            <div className="lg:col-span-2 flex flex-col gap-6.5">
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="absolute bottom-0 ltr:left-4 rtl:right-4 ltr:right-4 rtl:left-4 bg-white rounded-t-2xl px-4 py-3 flex items-center justify-between gap-3 shadow-[0_-1px_8px_rgba(48,93,116,0.06)]">
                          <div>
                            <h3 className="text-navy font-bold text-sm m-0 capitalize tracking-tight">{slug}</h3>
              ...
              {/* Quick Actions Panel */}
              <div className="bg-white rounded-3xl border border-border/85 p-6.5 shadow-sm">
                <h3 className="text-navy font-bold text-base mb-4.5">Quick Shortcuts</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {/* Shortcut 1 */}
                  <button
                    onClick={() => navigate("/admin/locations")}
                    className="group flex items-center gap-4 bg-[#F8FAFC] hover:bg-navy hover:text-white rounded-2xl p-4.5 transition-all duration-300 border-0 cursor-pointer ltr:text-left rtl:text-right w-full shadow-sm hover:shadow-lg hover:shadow-navy/10 hover:-translate-y-0.5"
                  >
                    ...
                    <div>
                      <p className="text-navy font-bold text-sm m-0 group-hover:text-white transition-colors duration-300">Manage Locations</p>
                      <p className="text-muted text-xs m-0 mt-0.5 group-hover:text-white/70 transition-colors duration-300">Upload & organize photos</p>
                    </div>
                    <i className="fa-solid fa-chevron-right text-muted/40 text-xs ltr:ml-auto rtl:mr-auto group-hover:text-white/80 group-hover:ltr:translate-x-0.5 group-hover:rtl:-translate-x-0.5 transition-all duration-300" />
                  </button>

                  {/* Shortcut 2 */}
                  <button
                    onClick={() => window.open("/", "_blank")}
                    className="group flex items-center gap-4 bg-[#F8FAFC] hover:bg-red hover:text-white rounded-2xl p-4.5 transition-all duration-300 border-0 cursor-pointer ltr:text-left rtl:text-right w-full shadow-sm hover:shadow-lg hover:shadow-red/10 hover:-translate-y-0.5"
                  >
                    ...
                    <div>
                      <p className="text-navy font-bold text-sm m-0 group-hover:text-white transition-colors duration-300">View Public Site</p>
                      <p className="text-muted text-xs m-0 mt-0.5 group-hover:text-white/70 transition-colors duration-300">Open client site in new tab</p>
                    </div>
                    <i className="fa-solid fa-chevron-right text-muted/40 text-xs ltr:ml-auto rtl:mr-auto group-hover:text-white/80 group-hover:ltr:translate-x-0.5 group-hover:rtl:-translate-x-0.5 transition-all duration-300" />
                  </button>
                </div>
